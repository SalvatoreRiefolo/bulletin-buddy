...
public class CommentInitializer implements InitializingBean {
    ...
    private final UUID OFFER_ID_1 = UUID.fromString("bb27a1b0-9602-4d1c-9a76-6ab5dca69837");
    private final UUID OFFER_ID_2 = UUID.fromString("1240ceb0-2d1b-4fb3-89e1-c30089b5222f");
